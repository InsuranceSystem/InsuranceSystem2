...
INSERT INTO Insurance (insuranceName, type, maxCompensation, periodOfInsurance, paymentCycle, paymentPeriod, ageOfTarget, basicPremium, rate, distributionStatus, termsIDList, insuranceClausePeriod, precaution, authorization) VALUES
        ('자동차보험A', 'Car', 10000000, '10년', '3년', '매월', '30세', 200000, 1.1, False, 'CAR001', '2년', '사고 발생시 보험금 지급을 위해 경찰 보고서 필요', True),
        ('건강보험A', 'Health', 5000000, '10년', '5년', '매월', '40세', 100000, 1.2, False, 'HLTH001,HLTH002', '없음', '선처리 요구사항 확인 필요', True),
        ('재물보험A', 'Property', 50000000, '5년', '일시납', '-', '35세', 500000, 1.3, False, 'PRTY001,PRTY002', '없음', '가입 후 30일 이내에 보험금 청구서 제출 필요', True),
        ('자동차보험B', 'Car', 1000000, '4년', '일시납', '-', '25세', 200000, 1.1, False, 'CAR001', '없음', '사고 발생시 보험금 지급을 위해 경찰 보고서 필요', True),
        ('화재보험A', 'Fire', 100000000, '20년', '10년', '매년', '45세', 1000000, 1.2, False, 'FIRE001', '없음', '화재 발생 시 경찰과의 협조 필요', True),
        ('종신보험A', 'Life', 500000000, '평생', '20년', '매년', '35세', 1000000, 1.2, False, 'LTMR001', '2년', '보험가입 후 2년 동안 자살에 의한 사망은 보험금 지급 제한', True),
        ('자동차보험C', 'Car', 20000000, '3년', '일시납', '-', '28세', 150000, 1.1, False, 'CAR002', '없음', '운전 중 음주로 인한 사고는 보험 적용 제한', True),
        ('건강보험B', 'Health', 3000000, '5년', '5년', '매월', '35세', 80000, 1.3, False, 'HLTH002', '없음', '의료기관 방문 시 의사소견서 필요', True),
        ('재물보험B', 'Property', 20000000, '1년', '일시납', '-', '40세', 300000, 1.2, False, 'PRTY002', '없음', '보험금 지급을 위해 재물 명세서 필요', True),
        ('종신보험B', 'Life', 200000000, '8년', '일시납', '-', '32세', 3000000, 1.1, False, 'LTMR001', '2년', '보험가입 후 2년 동안 자살에 의한 사망은 보험금 지급 제한', True),
        ('화재보험B', 'Fire', 200000000, '15년', '10년', '매년', '50세', 800000, 1.2, False, 'FIRE002', '없음', '화재 발생 시 보험금 지급을 위해 화재 경찰 조사 필요', True),
        ('종신보험C', 'Life', 1000000000, '평생', '30년', '매년', '40세', 2000000, 1.2, False, 'LTMR002', '5년', '보험 가입 후 3년 동안 자살에 의한 사망은 보험금 지급 제한', True),
        ('자동차보험D', 'Car', 5000000, '1년', '일시납', '-', '27세', 120000, 1.1, False, 'CAR003', '없음', '운전 중 교통법규 위반으로 인한 사고는 보험 적용 제한', True),
        ('건강보험C', 'Health', 1000000, '3년', '3년', '매월', '32세', 50000, 1.3, False, 'HLTH003', '1년', '일부 질병은 면책 기간이 적용될 수 있음', True),
        ('재물보험C', 'Property', 30000000, '3년', '일시납', '-', '38세', 350000, 1.2, False, 'PRTY003', '없음', '보험금 청구 시 사고 경위에 대한 상세한 설명 필요', True),
        ('자동차보험D', 'Car', 30000000, '5년', '일시납', '-', '30세', 400000, 1.1, False, 'FIRE003', '없음', '운전 중 음주로 인한 사고는 보험 적용 제한', False),
        ('화재보험C', 'Fire', 150000000, '10년', '5년', '매년', '55세', 700000, 1.2, False, 'FIRE002', '없음', '화재 발생 시 화재 경찰 조사 결과 필요', False),
        ('종신보험D', 'Life', 800000000, '평생', '40년', '매년', '42세', 1500000, 1.2, False, 'LTMR003', '없음', '7년 보험 가입 후 5년 동안 자살에 의한 사망은 보험금 지급 제한', False),
        ('자동차보험E', 'Car', 15000000, '2년', '일시납', '-', '31세', 180000, 1.1, False, 'CAR004', '없음', '운전 중 음주, 도주로 인한 사고는 보험 적용 제한', False),
        ('건강보험D', 'Health', 2500000, '7년', '7년', '매월', '37세', 90000, 1.3, False, 'HLTH004', '없음', '의료비 청구 시 영수증 및 진단서 제출 필요', False);
...
VALUES ('id1', '김철수', '회사원', '01012345678', '1997-11-19', '남', '서울특별시 서대문구 거북골로 12'),
       ...
       ('id4', '김나다', '교사', '01045678912', '1997-11-29', '여', '서울특별시 서대문구 거북골로 45'),
       ('id5', '김다라', '사육사', '01056789123', '1997-11-19', '여', '서울특별시 서대문구 거북골로 56'),
       ('id6', '김마바', '의사', '01067891234', '1997-11-19', '여', '서울특별시 서대문구 거북골로 67'),
       ('id7', '김바사', '간호사', '01078912345', '1997-11-19', '여', '서울특별시 서대문구 거북골로 78'),
       ('id8', '김사아', '회계사', '01089123456', '1997-11-09', '여', '서울특별시 서대문구 거북골로 89'),
       ('id9', '김아자', '교수', '01091234567', '1997-11-19', '여', '서울특별시 서대문구 거북골로 90');
