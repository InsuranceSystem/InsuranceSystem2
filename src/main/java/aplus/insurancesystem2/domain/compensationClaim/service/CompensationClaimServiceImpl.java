package aplus.insurancesystem2.domain.compensationClaim.service;

import aplus.insurancesystem2.domain.Insurance.entity.Insurance;
import aplus.insurancesystem2.domain.Insurance.service.InsuranceQueryService;
...
import aplus.insurancesystem2.domain.compensationClaim.exception.CarAccidentNotFoundException;
import aplus.insurancesystem2.domain.compensationClaim.exception.CompensationClaimNotFoundException;
import aplus.insurancesystem2.domain.compensationClaim.exception.SurveyNotFoundException;
import aplus.insurancesystem2.domain.compensationClaim.repository.CarAccidentRepository;
import aplus.insurancesystem2.domain.compensationClaim.repository.CompensationClaimRepository;
import aplus.insurancesystem2.domain.compensationClaim.repository.SurveyRepository;
